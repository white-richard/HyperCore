'''
Example of using HGAT for node classification task on disease dataset.
'''
import torch
...
encoder = HGAT(manifold, feat_dim, 16, n_classes)
decoder = encoder.decoder
model = NCModel(encoder, decoder, manifold, act=F.log_softmax)
print('model created')
print(str(model))
