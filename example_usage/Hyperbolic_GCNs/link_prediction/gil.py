'''
Example of using GIL for link prediction task on disease dataset
'''
import torch
...
model = LPModel(GIL(manifold, feat_dim, 16), manifold, nb_false_edges=nb_false_edges, nb_edges=nb_edges, weights_dim=16, max_norm=50.0)
print('model created')
print(str(model))
