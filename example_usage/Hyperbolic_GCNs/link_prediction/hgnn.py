'''
Example of using HGNN for link prediction task on disease dataset
'''
import torch
...
model = LPModel(HGNN(manifold, feat_dim, 16), manifold, nb_false_edges, nb_edges, max_norm=60.0)
print('model created')
print(str(model))
